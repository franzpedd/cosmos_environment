...
void main()
{
    outColor = texture(colorMapSampler, TransformUV(inFragTexCoord, meshParams.uv_offset, meshParams.uv_scale, radians(meshParams.uv_rotation)));
